...
Configure PA4 pin as GPIO_Output.

Click Middleware → Click FATFS -->
Tick User-defined
Go to Configuration → Set Defines:
...
//Library 2
//Inside Core/Src Folder: fatfs_sd.c
...
//Code Modification 1
//In Core/Src Folder (stm32f1xx_it.c)
...
//Code Modification 2
//In FATFS/Target Folder (user_diskio.c)
...
//Additional code on top of STM32CubeIDE generated code (Mounting the SD Card and Writing to a File)
...
//Additional code on top of STM32CubeIDE generated code (Checking SD Card Capacity and Free Space)
